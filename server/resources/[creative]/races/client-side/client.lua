			...
			if IsPedInAnyVehicle(ped) then
				...
				if Progress then
					...
					if distance <= 200 then
						...
						DrawMarker(21,Races[Selected]["coords"][Checkpoints][1],Races[Selected]["coords"][Checkpoints][2],Races[Selected]["coords"][Checkpoints][3] + 1,0,0,0,0,180.0,130.0,3.0,3.0,2.0,46,110,76,100,0,0,0,1)
