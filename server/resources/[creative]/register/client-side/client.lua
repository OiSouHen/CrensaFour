...
-----------------------------------------------------------------------------------------------------------------------------------------
local registers = {
	{ 122.88,-1036.81,29.27,62.37,"Sul" },
	{ 121.6,-1040.36,29.27,70.87,"Sul" },
	...
	{ 417.67,-1496.94,30.14,306.15,"Sul" },
	{ 414.7,-1498.36,30.16,36.86,"Sul" },
	{ -2072.22,-333.07,13.31,11.34,"Sul" },
	{ -2070.39,-333.24,13.31,354.34,"Sul" }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADTARGET
-----------------------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
	for k,v in pairs(registers) do
		exports["target"]:AddCircleZone("Register:"..k,vector3(v[1],v[2],v[3]),0.5,{
			name = "Register:"..k,
			heading = 3374176
		},{
			shop = k,
