...
local itensList = { "plastic","glass","rubber","aluminum","copper","techtrash","tarp","sheetmetal","roadsigns" }
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHLIST
-----------------------------------------------------------------------------------------------------------------------------------------
local vehList = {
...
function cRP.paymentMethod(vehicle)
	...
	if user_id then
		...
		vRP.generateItem(user_id,itensList[math.random(#itensList)],math.random(45,55),true)
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
