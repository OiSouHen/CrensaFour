...
local pedList = {
	...
	{ -- GangSystem
		distance = 50,
		coords = { 1392.7,3601.11,38.94,19.85 },
		model = "s_m_y_grip_01",
		anim = { "timetable@trevor@smoking_meth@base","base" }
	},
	{ -- GangSystem
		distance = 50,
		coords = { 278.68,6782.02,15.69,22.68 },
		model = "s_m_y_grip_01",
		anim = { "amb@world_human_bum_standing@twitchy@idle_a","idle_c" }
	},
	{ -- Roupa de Mergulho
		distance = 20,
	...
	{ -- Bean Machine
		distance = 20,
		coords = { 123.22,-1035.91,29.27,68.04 },
	...
	{ -- Bar
		distance = 25,
		coords = { 413.82,-1498.86,30.18,28.35 },
		model = "s_f_y_bartender_01",
		anim = { "amb@prop_human_bum_shopping_cart@male@base","base" }
	},
	{ -- Bowling
