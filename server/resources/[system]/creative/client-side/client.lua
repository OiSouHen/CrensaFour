...
local blips = {
	...
	{ 1839.67,3667.94,33.87,60,18,"Departamento | SHERIFF",0.6 },
	...
	{ 530.09,-181.8,54.21,402,11,"Mecânica",0.7 },
	...
	{ -580.93,-1074.92,22.33,408,62,"Dishes & Desserts",0.6 },
...
Citizen.CreateThread(function()
	while true do
		...
		if not IsPedInAnyVehicle(ped) then
			...
			local distance = #(coords - vector3(1585.09,6448.62,25.17))
			if distance <= 300 and (GetClockHours() <= 6 or GetClockHours() >= 19) then
				timeDistance = 1
				DrawLightWithRange(1588.73,6457.21,115.0,255,255,255,100.0,25.0)
			end
		end
